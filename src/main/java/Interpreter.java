...
public class Interpreter {
    ...
    private static char OPERATOR_UNION = '+';
    private static char OPERATOR_INTERSECT = '*';
    private static char OPERATOR_SYMMDIFFENCE = '|';
    private static char OPERATOR_COMPLEMENT = '-';
     ...
     */
    private Set<BigInteger> findIdentifier(Identifier identifier) throws APException {
